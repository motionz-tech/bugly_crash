...
public class BuglyCrashPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    mContext = (Context) flutterPluginBinding.getApplicationContext();
  ...
  public static void registerWith(Registrar registrar) {
    channel = new MethodChannel(registrar.messenger(), "bugly");
  ...
  public void onMethodCall(MethodCall call, Result result) {
    ...
    } else if (call.method.contains("testJavaCrash")){
